function Project(props) {
  ...
  if (props.arg === "0") {
    if (projectsArray[0].github) {
      var githubLink = <a className="github" href={projectsArray[0].github}>GitHub</a>;
    }
    return (
  ...
  if (projectsArray[props.arg].github) {
    var githubLink = <a className="github" href={projectsArray[props.arg].github}>GitHub</a>;
  }
